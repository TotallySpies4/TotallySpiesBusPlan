...
# Load the CSV file
data = pd.read_csv("congestionLevel.csv")  # Replace with the filepath of your dataset

# Filter data for a specific bus route
bus_route = "bus_route"
...
target_feature = "Congestion Level"
...
print("Today's predicted congestion level:", today_predicted_data[0])
print("Today's actual congestion level:", today_realtime_data[0][0])
